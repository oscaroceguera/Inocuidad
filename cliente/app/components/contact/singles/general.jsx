      ...
      <div>
        ...
        <div style={styles.FORM_FLEX_CONTAINER}>
          <TextField
            ...
            errorText={this._errorText('validates', 'companyName_valid', 'required')}
          />
          <TextField
            floatingLabelText='RFC'
            style={styles.TEXT_SMALL}
            valueLink={this.getReferenceFor('rfc')}
            errorText={this._errorText('validates', 'rfc_valid', 'rfcFormat')}
          />
          <SelectField
            value={this.props.values.country}
            onChange={this._onChange('country')}
            errorText={this._errorText('validates', 'country_valid', 'required')}
            autoWidth={true}
            style={styles.SELECT}
          ...
          <SelectField
            ...
            errorText={this._errorText('validates', 'state_valid', 'required')}
            autoWidth={true}
            style={styles.SELECT}
          ...
          <SelectField
            ...
            errorText={this._errorText('validates', 'city_valid', 'required')}
          ...
          <TextField
            ...
            errorText={this._errorText('validates', 'street_valid', 'required')}
            style={styles.TEXT_LARGE}
          ...
          />
          <TextField
            floatingLabelText='Email de la empresa'
            style={styles.TEXT_MEDIUM}
            valueLink={this.getReferenceFor('companyEmail')}
            errorText={this._errorText('validates', 'companyEmail_valid', 'emailFormat')}
          />
          <TextField
            floatingLabelText='Teléfono de la empresa'
            style={styles.TEXT_SMALL}
            valueLink={this.getReferenceFor('companyPhone')}
            errorText={this._errorText('validates', 'companyPhone_valid', 'required')}
          />
        </div>
      </div>
    )
